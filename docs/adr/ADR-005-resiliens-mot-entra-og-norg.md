...
- `RestRetryingWhenRecoverableService` brukes på tjenestelag mot Entra og NORG
...
- `RestRetryingWhenRecoverableService` inkluderer også `ResourceAccessException`
...
- [x] Behold `RestRetryingWhenRecoverableService` som felles retry-abstraksjon for recoverable feil

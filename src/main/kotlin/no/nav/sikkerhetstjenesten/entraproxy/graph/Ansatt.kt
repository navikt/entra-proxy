...
open class Ansatt(@param:JsonAlias(NAVIDENT)  val id: AnsattId,
...
class AnsattUtvidetInfo(@JsonAlias(NAVIDENT) id: AnsattId,
                        ...
                        @param:JsonAlias("officeLocation")  val enhet: String): Ansatt(id,navn,fornavn,etternavn)
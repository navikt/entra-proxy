...
class CaffeineCacheOperations(private val cacheManager: CacheManager) : CacheOperations {
    ...
    override fun delete(cache: CachableConfig, id: String) : Boolean {
    ...
    private fun caffeineNøkkel(cache: CachableConfig, id: String): String {
        val extra = cache.extraPrefix?.let { "$it:" } ?: ""
        return "$extra$id"
    }

    override fun clear(cache: CachableConfig): Long {
    ...
    override fun sizes(vararg caches: CachableConfig): Map<String, Long> =
